...
rebuilt=snapshot(RecordedSource(),datetime.fromisoformat(original['anchor_utc']),repo/'base-data',repo/'training/samples_identity_corrected.json.gz')
