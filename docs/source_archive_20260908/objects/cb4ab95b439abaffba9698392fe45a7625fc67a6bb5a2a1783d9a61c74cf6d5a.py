...
def pipeline_fingerprint(evaluate_func, edge_generator, noise_generator, *, metric: str) -> str:
    ...
    payload = {
        "metric": metric,
        "evaluate": describe(evaluate_func),
        "edge_generator": describe(edge_generator),
        "noise_generator": describe(noise_generator),
    }
