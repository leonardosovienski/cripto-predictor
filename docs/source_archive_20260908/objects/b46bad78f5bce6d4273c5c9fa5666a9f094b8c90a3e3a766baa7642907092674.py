...
def to_trade_intent(
    ...
    *,
    ...
    # Todo caminho que materializa uma intencao resolve primeiro a politica de
    # custo canonica. Classe desconhecida falha aqui, nunca depois da execucao.
    cost_model_for(instrument)
