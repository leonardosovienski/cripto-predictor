...
| Revogação de chaves antigas | Rotação confirmada pelo dono e redação de logs já corrigida | Evidência dos painéis sobre revogação/uso anterior; não é suprida por geração bem-sucedida com chave nova |
