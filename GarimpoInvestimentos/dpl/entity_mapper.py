...
class EntityMapper:
    ...
    def add_alias(self, source: str, type: str, raw_name: str, canonical_id: str,
                  curated_by: str | None = None) -> None:
        self._conn.execute(
    ...
    def suggest(self, raw_name: str, type: str = "team", n: int = 3) -> list[str]:
        ...
        rows = self._conn.execute(
            "SELECT DISTINCT canonical_id, display_name FROM entity_canonical WHERE type=?",
            (type,)).fetchall()
