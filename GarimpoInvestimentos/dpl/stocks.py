...
class StocksDataProvider:
    ...
    def __init__(self, price_providers: list[DataProvider],
    ...
    @classmethod
    def from_cotahist(cls, file_path: str | Path,
                      signal_providers: list[SignalProvider] | None = None):
...
async def ingest_stocks(store: FeatureStore, facade: StocksDataProvider, symbol: str,
                        *, interval: str = "1d", limit: int = 300, max_staleness=None,
                        run_id: str | None = None, code_version: str | None = None,
    ...
    store.write_provenance(
        ...
        run_id=run_id, origin="cotahist+bcb", code_version=code_version,
    )
    return aligned
