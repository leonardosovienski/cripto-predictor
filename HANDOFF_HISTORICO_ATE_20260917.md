> **Ops dependency update:** source/CI pins now use published Ops 4.2.1 (SHA256 da4fa540703879669caba919521ec7d3c33734b5d57781122823df8817346f0e). Installed real wrapper tests preserved SKIPPED -> 3, success -> 0 and failure -> 1 using synthetic data. The operational .venv was subsequently upgraded to Ops 4.2.1 on 2026-09-13; dependency and synthetic integration checks passed. Backup and receipt: C:/CRIPTO/operacao/relatorios/OPS_DEPLOYMENT_20260913.md. No schedules were activated. No domain code, scientific protocol or consumer release changed. See predictor-ops docs/stabilization-20260912/REPORT.md for evidence.
